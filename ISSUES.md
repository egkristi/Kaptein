...
| T | Hygiene | **Core dumps are escalating, not static.** 14 dumps totalling **641 MB** are in the working tree, dated across four days. The *Hygiene notes* section below still says "Two dumps (~240 MB)" — understated ~3× and no longer a one-off. Something crashes on essentially every session and nothing identifies it. *Still climbing: **16 dumps / 732 MB** at the second v0.30.0 pass.* | Hygiene |
